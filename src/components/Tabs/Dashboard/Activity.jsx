...
class Activity extends React.Component {
  ...
  render() {
    const { firstname, lastname, profilePicture } = this.state.user;
    return (
      <div className="container activity">
        ...
        <div className="get-data-from-user">
          <List>
            <ListInput type="textarea" placeholder="Comment" clearButton resizable />
            <ListInput type="textarea" placeholder="Suuggestion" clearButton resizable />
            <ListInput type="textarea" placeholder="Question" clearButton resizable />
            <div className="">
              <Icon material="star" />
              <Icon material="star" />
